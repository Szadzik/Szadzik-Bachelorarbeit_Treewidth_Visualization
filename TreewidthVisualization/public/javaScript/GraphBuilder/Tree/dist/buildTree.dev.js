      ...
      switch (line[0]) {
        ...
        case 'b':
          ...
          if (line.length <= 2) {
            ...
            var message = 'Tried to define a bag,but this is not a bag on textline: ' + "lineNumber" + '.' + '</br>' + 'Be sure to follow the bag format: ' + '"<b><span style=color:blue> b </span> <span style=color:red> n </span> <span style=color:green> k" </span> </b>' + ', where n is <span style=color:red> the bag number </span> and <span style=color:green> k </span> ' + 'a <span style=color:green> list of nodes</span> (can be empty) of the  <span style=color:blue> bag </span> b. ';
        ...
        default:
          ...
          if (line.length <= 2) {
            // <= because of empty last index
            var _message = 'Cannot create a loop edge on a node in line:' + lineNumber;
