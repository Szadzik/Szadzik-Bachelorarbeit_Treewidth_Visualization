 ...
 * which starts with the function calucatePostionCircle if the "preset layout" is called.
 * Beforehand, the mapAngle function must be called in the buildHandler.
 * How this works:
 * It takes the start position from each bag and calculate the node position on this.
