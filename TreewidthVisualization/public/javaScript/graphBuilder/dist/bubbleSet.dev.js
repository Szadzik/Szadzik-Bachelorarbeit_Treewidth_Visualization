...
function removeBubble() {
  // console.log("was ist bb ", bb.destroy())
  //path.remove();
  //cr.nodes('.construct').map(d => d.scratch('_bb'))
  //bb.removePath(path);
  //cr.scratch("_bb");
  // let z = cr.nodes(".construct").map((d) => d.scratch("_bb"))
  //console.log("cratch z ", z) //if <1 dann bereits ein cluster
  // cr.ready(() => {
